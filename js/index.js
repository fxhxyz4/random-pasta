const pastaText = document.querySelector('.main__text')
const copyBtn = document.querySelector('.main__copy')
const rndBtn = document.querySelector('.main__button')
const alertBtn = document.getElementById('id')
